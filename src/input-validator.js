;(function() {
  ...
  document.body.addEventListener('focusout', function(e) {
    if (e.target.getAttribute('is') === 'input-validator')
      inputHandler(e.target, e.type)
  })

  document.body.addEventListener('input', function(e) {
    if (e.target.getAttribute('is') === 'input-validator' && e.target[namespace + 'invalid'] !== undefined)
      inputHandler(e.target, e.type);
  });
  ...
  */
  document.body.addEventListener('submit', function(e) {
    ...
    var inputs = [].slice.apply(e.target.querySelectorAll('[is="input-validator"]'));
    var isValid = true;
